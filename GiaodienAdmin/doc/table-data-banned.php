...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../images/2336.jpg" width="50px"
        alt="User Image">
      <div>
        <p class="app-sidebar__user-name"><b>Văn Chính</b></p>
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="quanlimenu/menungang.php"><i class='app-menu__icon bx bx-user-voice'></i><span
            class="app-menu__label">Quản lý menu</span></a></li>
      ...
      <li><a class="app-menu__item" href="quan-ly-tai-khoan.php"><i
            class='app-menu__icon bx bx-pie-chart-alt-2'></i><span class="app-menu__label">Quản lý tài khoản</span></a>
      </li>
