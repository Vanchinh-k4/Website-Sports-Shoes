              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  while($row=mysqli_fetch_assoc($result)){
                    ...
                    echo '<td class="view_order"><a href="view-order.php?id='.$row["id"].'">Xem</a></td>';
                    echo '<td><span data-id="'.$row["id"].'" class="trash" ><button class="btn btn-primary " type="button" title="Xóa"><i class="fas fa-trash-alt"></i> </button></span>';                 
                    echo '</tr>';
                  }
                  ?>
                </tbody>
...
<script src="js/processing_delete_order.js"></script>
