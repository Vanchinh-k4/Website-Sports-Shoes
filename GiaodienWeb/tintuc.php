          ...
          while($row_result=mysqli_fetch_assoc($sql_query))    
           {
            ?>
            <div class="col-sm-3">
              <a href="chitiettintuc.php?id=<?php echo $row_result["id"] ?>"><img src="../GiaodienAdmin/doc/<?php echo $row_result["img"] ?>"alt=""></a>
              <a href="chitiettintuc.php?id=<?php echo $row_result["id"] ?>"><p><?php  echo $row_result["title"]?></p></a>
            </div>
           <?php }?>
